...
namespace SuperGrate
{
    class Config
    {
        ...
        public static Dictionary<string, string> Settings = new Dictionary<string, string>() {
            ...
            {"USMTPathX64", @".\SuperGrate\USMT\X64"},
            {"USMTPathX86", @".\SuperGrate\USMT\X86"},
            ...
            {"MigrationStorePath", @".\SuperGrate\STORE"},
            {"Classes/Config/Comment/ScanLoadStateParams", string.Empty},
            {"ScanStateParameters", "/config:Config_AppsAndSettings.xml /i:MigSgAdditional.xml /c /r:3 /o /vsc /v:13"},
            {"LoadStateParameters", "/config:Config_AppsAndSettings.xml /i:MigSgAdditional.xml /c /r:3 /lac /lae /v:13"},
            ...
            {"DumpLogHereOnExit", @".\SuperGrate\LOGS"},
