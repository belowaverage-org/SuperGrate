...
namespace SuperGrate
{
    class Logger
    {
        ...
        private static void WriteLog(string Text, Color Color, bool Raw = false)
        {
            try
            {
                ...
                Main.Form.Invoke(new Action(() =>
                {
                    ...
                    {
                        Console.WriteLine(Language.Get("Class/Logger/Log/Failed/WriteErrorToWindow"));
                    }
                }));
            }
            catch (Exception) {
        ...
        public static void Information(string Text, bool Raw = false)
        {
            ...
            WriteMemoryLog(Text, Language.Get("Class/Logger/Prefix/Info"));
        }
        /// <summary>
        ...
        public static void Success(string Text, bool Raw = false)
        {
            ...
            WriteMemoryLog(Text, Language.Get("Class/Logger/Prefix/Success"));
        }
        /// <summary>
        /// Logs a warning.
        /// </summary>
        ...
        public static void Warning(string Text, bool Raw = false)
        {
            ...
            WriteMemoryLog(Text, Language.Get("Class/Logger/Prefix/Warning"));
        }
        /// <summary>
        /// Logs an error.
        /// </summary>
        ...
        public static void Error(string Text, bool Raw = false)
        {
            ...
            WriteMemoryLog(Text, Language.Get("Class/Logger/Prefix/Error"));
        }
        /// <summary>
        ...
        public static void Verbose(string Text, bool Raw = false)
        {
            ...
            WriteMemoryLog(Text, Language.Get("Class/Logger/Prefix/Verbose"));
        }
        /// <summary>
        /// Logs an exception.
        /// </summary>
        ...
        public static Task WriteLogToFile(Stream fs)
        {
            ...
            {
                Exception(e, Language.Get("Class/Logger/Log/Failed/WriteLogToDisk"));
                return null;
            }
        }
    }
